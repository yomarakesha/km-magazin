...
export const CONTENT: Record<Lang, Content> = {
  ru: {
    ...
    stats: [["8", "направлений работ"], ["Под ключ", "полный цикл"], ["Гарантия", "на оборудование и монтаж"], ["Сервис", "техническая поддержка"]],
    ...
    advCode: "ПОЧЕМУ KM", advTitle: "Наши преимущества",
  ...
  tk: {
    ...
    stats: [["8", "iş ugry"], ["Açar bilen", "doly aýlaw"], ["Kepillik", "enjama we gurnama"], ["Hyzmat", "tehniki goldaw"]],
    ...
    advCode: "NÄME ÜÇIN KM", advTitle: "Artykmaçlyklarymyz",
  ...
  en: {
    ...
    stats: [["8", "areas of work"], ["Turnkey", "full cycle"], ["Warranty", "on equipment & installation"], ["Service", "technical support"]],
    ...
    advCode: "WHY KM", advTitle: "Our advantages",
